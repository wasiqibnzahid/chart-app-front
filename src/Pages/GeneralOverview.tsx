      ...
      <div className="main">
        ...
        <div className="row custom-row mt-2 ">
          <div className="col-12">
            <div className="box shadow mt-2">
              <div id="barchart">
              <PipeCombineChart data={data}  titleHeading="General Overview - TVA vs. Comp. Individual Bar charts"/>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="row custom-row mt-2 ">
          <div className="col-12">
            <div className="box shadow mt-2">
              <div id="barchart">
                <PipeCombineChart data={data}  titleHeading="General Overview - TVA vs. Comp. Weeb by Week Bar"/>
              </div>
            </div>
          </div>
        </div>
