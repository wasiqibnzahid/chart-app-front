  ...
  return (
    <Box p={0} mb={0} borderRadius="lg" position="relative" height="530px">
      ...
      >
        ...
        <TileLayer
          // Using NASA GIBS with a date that should exist
          url="https://gibs.earthdata.nasa.gov/wmts/epsg3857/best/VIIRS_SNPP_CorrectedReflectance_TrueColor/default/2023-08-01/{z}/{y}/{x}.jpg"
          attribution="Imagery by NASA GIBS, OpenStreetMap contributors"
        />
